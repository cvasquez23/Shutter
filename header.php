   ...
   <body <?php body_class(); ?>>
      ...
      <nav id="home" class="navbar navbar-expand-lg navbar-light bg-light fadeIn">
         <div class="social-media d-lg-none">
            <a href="https://www.facebook.com/pages/category/Photographer/Kim-Zuidema-Giems-Photography-392580977567305/"><i class="fab fa-facebook-f fa-3x"></i></a>
            <a href=""><i class="fab fa-twitter fa-3x"></i></a>
            <a href=""><i class="fab fa-pinterest-p fa-3x"></i></a>
