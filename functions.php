...
function enqueue_shutter_styles() {
   ...
   wp_enqueue_style('googlefont', '//fonts.googleapis.com/css?family=Montserrat|Old+Standard+TT|Spectral:400,600&display=swap');
   ...
   wp_enqueue_script('bootstrap-js', '//stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js', array('jquery'));
